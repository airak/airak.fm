...
class TwitterAPI:
    def __init__(self):
        self.api_key = config('API_KEY_TWITTER')
        self.api_secret = config('API_SECRET_TWITTER')
        self.client_id = config('CLIENT_ID_TWITTER')
        self.client_secret = config('CLIENT_SECRET_TWITTER')
